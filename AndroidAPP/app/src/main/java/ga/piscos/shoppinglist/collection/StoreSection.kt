...
class StoreSection (val code:String,val  name:String,val index:Int,val finishedSection:Boolean,val notAvailableSection:Boolean, var products:List<ProductItem>?=null):
    CollectionItemRow {
