...
public class FBProductsRepository {
    private DatabaseReference mProductsDB;
    ...
    public FBProductsRepository(){
        mProductsDB = FirebaseDatabase.getInstance().getReference();
        mProductsDB = mProductsDB.child(NODE);
    }
    ...
    public  void  fetchProducts(final ProductsDownloadedListener listener){
        ...
        mProductsDB.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
